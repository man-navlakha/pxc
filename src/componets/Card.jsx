...
const Card = (props) => {
  ...
  return (
    <div className="div h-[4em] w-32 hover:shadow-md hover:border-emerald-500 border-emerald-800 border-2 bg-white m-auto rounded-[1em] overflow-hidden relative group p-2 z-0">
      <div className="circle absolute h-[5em] w-[5em]  -top-[2.5em] border-emerald-800 border-2 blur-[5px] -right-[3.5em] rounded-full bg-emerald-200 group-hover:scale-[800%] duration-500 z-[-1] op" />
