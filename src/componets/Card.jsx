...
const Card = (props) => {
    ...
    //     const courseName = queryParams.get('course');
        ...
        // console.log(b.b);
  return (
    <div className="div f-black shadow-[4px_5px_0px_0px_#065f46] hover:scale-110 h-[4em] w-32 hover:shadow-md hover:border-emerald-500 border-emerald-800 border-2 bg-white m-auto overflow-hidden relative group p-2 z-0">
