...
const Sub_card = ({ subject, onClick }) => {
  return (
    <div onClick={(event) => onClick(event, subject.id)}>
       <div className="flex items-center bg-emerald-600 border-emerald-800 border-2 border-dashed mb-2 mr-4 wrap-text  text-gray-800 shadow-[4px_5px_0px_0px_#065f46] hover:shadow-[2px_2px_0px_0px_#065f46] cursor-pointer">
