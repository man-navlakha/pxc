...
const Footer = () => {
  return (
    <div className='bg-gradient-to-t from-emerald-700  to-transparent bottom-0 backdrop-opacity-15 backdrop-blur-md text-white text-center -mb-12 mt-10 p-4'>
        
    

    <footer className="bg-white rounded-lg backdrop-opacity-15 backdrop-blur-md text-white">
