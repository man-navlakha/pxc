...
const Forgetpassword = () => {
  ...
  return (
    ...
    <div className="p-6 w-full max-w-sm">
      <div className="mb-6">
        <h1 className="text-2xl font-ff font-bold">Forget your password of,</h1>
      ...
      <form className="space-y-4" >
        ...
        <div>
          ...
          <input type="email" name="email" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter your registed email address" required />
        </div>
