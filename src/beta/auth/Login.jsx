...
<p className="mt-4 text-gray-500 dark:text-gray-600 font-normal text-sm text-center">I does'n have an profile? <a className="text-gray-500 hover:text-gray-1k hover:underline font-semibold transition-all ease-in-out" href="/beta/auth/signup">Sign Up</a></p>
            </div>
