...
const Choose = () => {
    ...
    const handleClick = (choose) => {
        choose === 'Notes' && navigate(`/old/nss?course=${course}&sub=${sub}&choose=${choose}`);
        choose === 'Assignment' && navigate(`/old/select?course=${course}&sub=${sub}&choose=${choose}`);
        choose === 'Exam' && navigate(`/old/nss?course=${course}&sub=${sub}&choose=${choose}`);
        choose === 'practical' && navigate(`/old/nss?course=${course}&sub=${sub}&choose=${choose}`);
        choose === 'I.M.P' &&
            navigate(`/old/select?course=${course}&sub=${sub}&choose=${choose}`);
    };
