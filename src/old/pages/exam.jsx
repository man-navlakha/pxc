  ...
  return (
    <>
      <div className='dark:bg-[#1E1E1E] dark:text-white h-screen overflow-y-scroll'>
        ...
        <div className='p-6 dark:bg-[#1E1E1E] dark:text-white  h-screen overflow-y-scroll  mb-15'>
          {loading ? (
            <Pdf_loader />
          ) : pdfData.length > 0 ? (
            pdfData
...
>
  ...
  <span
    className="text-sm font-extrabold leading-none text-white transition-all duration-200 group-hover:opacity-0"
    >Ask AI</span
  >
</button>
    </a>
