...
const View = () => {
  ...
  return (
    <div className='p-4 flex h-max text-white flex-col text-center content-center flex-nowrap jusify-center gap-3 items-center '>
      <Top />
      <div>
        <span className='text-center m-3 text-3xl md:text-lg lg:text-5xl font-black bg-clip-text bg-gradient-to-br from-white to-zinc-500 text-transparent ccf '>Experience premium handwritten notes!</span>
      </div>
      {/* <div>
