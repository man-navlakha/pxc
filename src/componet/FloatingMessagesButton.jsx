...
export default function FloatingMessagesButton() {
  ...
  return (
    <button
      ...
      className="fixed hidden md:hidden lg:block bottom-[6rem] right-6  border border-[#f8f9f90d] space-x-4 hover:bg-[#3A3B3C] bg-[#212328] rounded-full px-6 py-3 max-w-[140px] w-full shadow-lg z-50"
    >
