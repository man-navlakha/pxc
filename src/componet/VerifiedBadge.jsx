...
export default function VerifiedBadge({ size = 20, className }) {
  return (
    <svg
      ...
      className={className} // Allows you to add custom classes like margins
    >
      {/* Note: Ensure the CSS variable '--gray-00' is defined in your global CSS */}
      <rect x="1" y="1" width="18" height="18" rx="9" fill="rgb(var(--gray-00))" />
      <path
        ...
        fill="url(#gradient-verified-badge)" // Renamed ID for clarity
      />
      <path
        d="M6.66667 10.254L8.66667 12.1112L13.3333 7.77783"
        stroke="#fff"
        strokeWidth="1.2" // Converted to camelCase
        strokeLinecap="round" // Converted to camelCase
        strokeLinejoin="round" // Converted to camelCase
      />
      <rect
        x="1"
        y="1"
        ...
        strokeWidth="2" // Converted to camelCase
      />
      <defs>
        <linearGradient
          id="gradient-verified-badge" // Renamed ID for clarity
          x1="9.9999"
          y1="2"
          x2="9.9999"
          y2="18"
        ...
        >
          <stop stopColor="#27AE60" /> {/* Converted to camelCase */}
          <stop offset="1" stopColor="#1E874B" /> {/* Converted to camelCase */}
        </linearGradient>
      </defs>
    </svg>
  );
